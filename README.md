...
<p align="center">
  <img height="300" width="1200" src="https://github-readme-stats-one.vercel.app/api/top-langs/?username=Viniciusrz7&layout=compact&langs_count=7&theme=dracula" />
</p>

### 🛠️ Toolbox de Tecnologias
<p align="center">
  <a href="https://skillicons.dev">
<img src="https://skillicons.dev/icons?i=java,py,cs,ts,js,html,css,spring,maven,hibernate,nestjs,nodejs,express,graphql,dotnet,redis,tensorflow,sqlite,postgres,mysql,mongodb,supabase,firebase,prisma,react,nextjs,angular,vue,jquery,tailwind,bootstrap,vite,electron,flutter,aws,cloudflare,docker,kubernetes,jenkins,github,gitlab,terraform,linux,nginx,prometheus,grafana,vscode,visualstudio,idea,ai,git,npm,postman,figma,vercel,netlify" />
  </a>
</p>
